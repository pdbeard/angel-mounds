(function() {
  ...
  function mediaItem(zIndex) {
    ...
    function link(scope, element) {
      var newTransform = {};
      var tempRotation = 0; // hack to compensate for spurious touchThis rotation
      ...
      scope.item.touchThis = function (event) {
        ...
        tempRotation = event.rotation;
        newTransform = scope.item.transform;
      };
      ...
      scope.item.manipulateThis = function (event) {
        var transform = scope.item.transform,
            ...
            angleNew = transform.angle + event.rotation - tempRotation;
